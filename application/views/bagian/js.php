...
<script>
  function hitung_lembur(evt){
    var tunj_lembur = document.getElementById('tunj_lembur').value;
    var jumlah_jam = document.getElementById('jumlah_jam').value;
    document.getElementById('total_tunj_lembur').value = parseFloat(tunj_lembur) * parseInt(jumlah_jam);
    // var total = document.getElementById('total_tunj_lembur').value;
    if (tunj_lembur === null || jumlah_jam === null){
      document.getElementById('total_tunj_lembur').value = 0;
    }
  }
</script>
<script>
